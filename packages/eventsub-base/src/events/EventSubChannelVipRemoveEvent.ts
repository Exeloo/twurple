...
import type { EventSubChannelVipRemoveEventData } from './EventSubChannelVipRemoveEvent.external';

@rtfm<EventSubChannelVipRemoveEvent>('eventsub-base', 'EventSubChannelVipRemoveEvent', 'broadcasterId')
export class EventSubChannelVipRemoveEvent extends DataObject<EventSubChannelVipRemoveEventData> {
	/** @internal */ @Enumerable(false) private readonly _client: ApiClient;

	/** @internal */
	constructor(data: EventSubChannelVipRemoveEventData, client: ApiClient) {
		super(data);
		this._client = client;
	}
