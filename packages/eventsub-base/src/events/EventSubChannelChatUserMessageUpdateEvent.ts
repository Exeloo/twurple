...
import type {
	EventSubChannelChatUserMessageUpdateEventData,
	EventSubChannelChatUserMessageUpdateStatus,
} from './EventSubChannelChatUserMessageUpdateEvent.external';
...
export class EventSubChannelChatUserMessageUpdateEvent extends DataObject<EventSubChannelChatUserMessageUpdateEventData> {
	...
	get status(): EventSubChannelChatUserMessageUpdateStatus {
